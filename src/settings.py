...
CONFERENCE_USERS = [u'@AAAIConference', u'@kdd_news', '@eswc_conf', '@WSDMSocial', '@naacl', '@SIGIRForum', '@NipsConference', '@icmlconf', '@snow_workshop', '@ACMSIGIR', '@ysm_conference', '@ACMRecSys', '@recsyschallenge', '@UMAPconf', '@SemanticsConf', '@ACMHT', '@gamifir', '@nlpandcss', '@clef_initiative', '@fatconference', '@NAACLHLT']
