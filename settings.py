...
CONFERENCE_USERS = [u'@AAAIConference', u'@kdd_news', '@eswc_conf', '@WSDMSocial', '@naacl', '@SIGIRForum', '@NipsConference', '@icmlconf', '@snow_workshop', '@ACMSIGIR', '@ysm_conference', '@ACMRecSys', '@recsyschallenge', '@UMAPconf', '@SemanticsConf', '@ACMHT', '@gamifir', '@nlpandcss', '@clef_initiative']
CONFERENCE_HASHTAGS = ['#ICLR', '#SIGIR', 'icwsm', '#russir', 'sigmod', '#datasmt', '#ictir', '#jmlr']
...
CONFERENCES_2017 = ['#WWW2017', '#essir2017', '#WSDM2017', 'ecir2017', '#acmht17', '#sigir2017', '@SIGIR17', '#ictir2017', '#icmr2017', 'icmr17', 'iclr2017', 'www2017Perth', '#recsys2017', 'SemEval2017', 'CLEF2017', 'ISWC2017', '#AAAI17', '#AAAI2017', 'eswc2017', 'IJCAI17', 'eacl2017', 'ICWE2017', 'vldb2017']
CONFERENCES_2018 = ['@www2018', '#LREC2018']
...
COMMUNITIES = {'VLDB': ['vldb2017'],
               ...
               'EACL': ['eacl2017'],
               'AI': ['#AAAI17', '#AAAI2017'],
               'NLP': ['naacl2016', 'acl2016berlin', 'emnlp2016', 'LREC2016', 'eacl2017'],
               'InformationRetrieval': ['sigir2016', 'recsys2016', 'ictir2016'],
               'SemanticWeb': ['iswc2016'],
               'WebScience': ['websci16', 'WSDM2017', 'kdd2016', 'cikm2016', 'www2017Perth', 'WWW2017', 'ICWE2017'],
               'MachineLearningResearch': ['nips2016', 'jmlr', 'icml2016', 'WiML2016', 'iclr2016', 'iclr2017', 'iclr']}
